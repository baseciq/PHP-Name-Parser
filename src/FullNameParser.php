...
class FullNameParser
{
  ...
  protected $dict = array(
    ...
    'suffixes' => array(
      'line' => array('I', 'II', 'III', 'IV', 'V', '1st', '2nd', '3rd', '4th', '5th', 'Senior', 'Junior', 'Jr', 'Sr', 'SJ', 'OP'),
      'prof' => array(
        'AO', 'B.A.', 'M.Sc', 'BCompt', 'PhD', 'Ph.D.', 'APR', 'RPh', 'PE', 'MD', 'M.D.', 'MA', 'DMD', 'CME', 'BSc', 'Bsc', 'BSc(hons)', 'Ph.D.', 'BEng', 'M.B.A.', 'MBA', 'FAICD', 'CM', 'OBC', 'M.B.', 'ChB', 'FRCP', 'FRSC',
    ...
    if ($line_match !== false) {
      ...
      if ($word == 'senior' || $word == 'junior') {
        ...
        foreach ($temp_array as $suffix) {
          if (preg_match("/\b" . $suffix . "\b/iu", $name)) {
            return false;
          }
        }
      }
